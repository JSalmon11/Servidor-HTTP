...
public class ServerThread implements Runnable {
    ...
    private static byte[] componerRespuesta(String m) {
        ...
        String preExt = "text";
        if (ext.equals("png") || ext.equals("ico") || ext.equals("jpg")) {
            preExt = "image";
        }
        ...
        //Crea el byteBuffer que llevara el mensaje para enviar, con la cabecera, y
        //el contenido solicitado, allocate para usar la longitud necesaria del mensaje completo
